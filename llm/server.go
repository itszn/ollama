...
func NewLlamaServer(gpus discover.GpuInfoList, model string, ggml *GGML, adapters, projectors []string, controlVectors []string, opts api.Options, numParallel int) (LlamaServer, error) {
	var err error
